                  ...
                  <form method="POST" ">
                    <table  id="dataTable" width="60%" border="0px" cellspacing="0">
                      <thead>
                        <tr>
                          <th>* ID du Coupon</th>
                          <th> <input type="text" value="<?PHP echo $idc?>"placeholder="" class="form-control form-control-user" maxlength="25" id="" width="30%" onblur="verifNomTransporteur(this) "name="idc">
                          </th>
                        </tr>
                      </thead>
                      <thead>
                        <tr>
                          <th>* Nom du Coupon</th>
                          <th> <input type="text" value="<?PHP echo $nomc?>" name="nomc"placeholder="" class="form-control form-control-user" maxlength="25" id="exampleInputEmail" width="30%" onblur="verifAdresseTransporteur(this)">
                          </th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          <th>* Valeur</th>
                          <th><input width="10%" type="text" value="<?PHP echo $valeur?>" name="valeur"class="form-control form-control-user"  aria-describedby="emailHelp"  placeholder="" onblur="verifDelai(this)"></th>
                        </tr>
                      </thead>
						<thead>
                        <tr>
                          <th>* Date d'Expiration</th>
                          <th><input width="10%" type="date" value="<?PHP echo $dateE?>" name="dateE" class="form-control form-control-user"  placeholder="" onblur="verifvitesse(this)" ></th>
                        </tr>
                      </thead>
						         <tfoot>
                       
                      <th> 
            <input value="Modifier" name="modifier"  type="submit"class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> 
