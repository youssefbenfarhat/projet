...
if (isset($_GET['id'])){
  ...
  $result=$commandeC->rechercherListeCommandes($_GET['id']);
...
<i class="fas fa-store-alt"></i>
    ...
    <li class="nav-item">
        ...
        <div id="collapseCl" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
         <form action="afficherclient.php">
            <input type="submit" class="collapse-item" value="Clients">
         </form>
            <form action="adresse.php">
            <input type="submit" class="collapse-item" value="Carte fidelité">
         </form>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Chourou Med Amine</span>
