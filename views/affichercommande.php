      ...
      <li class="nav-item">
        ...
        <div id="collapseCom" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="affichercommande.php">Afficher Commandes</a>
        ...
        <a class="collapse-item" href="stat.php">Stats</a>
          </div>
        </div>
      </li>
          ...
          <div class="row">
            ...
            <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                    ...
                    <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                      ...
                      <tbody>
                         ...
                         ?><tr>
                          ...
                          <th>
                            <a href="modifiercommande.php?id=<?PHP echo $row['id']; ?>"></a>
                <button type="submit" name="modifier" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">MODIFIER</button></a>
                  </th>
              </form>
                ...
                <input type="submit" value="TRIER SELON ID" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
              </form>
