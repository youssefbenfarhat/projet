            ...
            <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">1&nbsp; Paramètres généraux</h6>
                </div>
<div class="card-body">
                <div class="table-responsive">
                  <form method="POST" action="ajoutercoupon.php">
                    <table  id="dataTable" width="60%" border="0px" cellspacing="0">
                      <thead>
                        <tr>
                          <th>* ID du Coupon</th>
                          <th> <input type="text" placeholder="" class="form-control form-control-user" maxlength="25" id="" width="30%" onblur="verifNomTransporteur(this) "name="idc">
                          </th>
                        </tr>
                      </thead>
                      <thead>
                        <tr>
                          <th>* Nom du Coupon</th>
                          <th> <input type="text" name="nomc"placeholder="" class="form-control form-control-user" maxlength="25" id="exampleInputEmail" width="30%" onblur="verifAdresseTransporteur(this)">
                          </th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          <th>* Valeur</th>
                          <th><input width="10%" type="text" name="valeur"class="form-control form-control-user"  aria-describedby="emailHelp"  placeholder="" onblur="verifDelai(this)"></th>
                        </tr>
                      </thead>
						<thead>
                        <tr>
                          <th>* Date d'Expiration</th>
                          <th><input width="10%" type="date" name="dateE" class="form-control form-control-user"  placeholder="" onblur="verifvitesse(this)" ></th>
                        </tr>
                      </thead>
						         <tfoot>
                       
                      <th> 
            <input value="Ajouter un transporteur" type="submit"class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> 
                      </th>
                      </tfoot>
                    </table>
                    </form>
      ...
      <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Tableau Des Coupons </h6>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td><form method="POST" action="supprimercoupon.php"><button style="background-color: transparent;border: 0px" type="submit" title="Supprimer"><i class="fas fa-trash-alt"></i></button>
                         <input type="hidden" value="<?php echo $row['idc']; ?>" name="idC"></form></td> 
                          <td><a href="modifiercoupon.php?idc=<?PHP echo $row['idc']; ?>"><button style="background-color: transparent;border: 0px" title="Modifier" ><i class="fas fa-pen"></i></button></a></td>
